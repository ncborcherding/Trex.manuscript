...
table(list$CD4.annot, list$seurat_clusters, useNA = "ifany")
```
...
DimPlot(list, label = TRUE)  + scale_color_manual(values = viridis_pal(option = "H")(length(unique(list$seurat_clusters)))) + NoLegend()
saveRDS(list, file = "./data/Fullintegrated_seuratObjects.rds")
```
